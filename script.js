...
// // Add optional auto-scroll after adding task
// function scrollToTasks() {
//   const taskTable = document.querySelector("#all-tasks");
//   if (taskTable) {
//     taskTable.scrollIntoView({ behavior: "smooth" });
//   }
// }

// // Modify inside `taskObj.addTask` after `this.showAllTasks();`
// this.showAllTasks();
// scrollToTasks();

// // Optional: Add spacing divs in HTML where needed
